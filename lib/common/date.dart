...
import 'package:flutter_my_picker_null_safety/common/date_util.dart';
...
class MyDate {
  ...
  static String format(String newPattern, [dynamic date]) {
    // return DateFormat(newPattern).format(MyDate.parse(date));
    return DateUtil.formatDate(date,format: newPattern);
  }
